    ...
    return (
          <div className="space-y-8 max-w-2xl mx-auto">
                <div className="glass-morphism p-8 rounded-3xl">
                        <h2 className="text-3xl font-bold mb-6 gradient-text">Issuer Dashboard</h2>h2>
                        <div className="space-y-4">
                                  <div>
                                              <label className="block text-sm font-medium mb-1">Student Wallet Address</label>label>
                                              <input 
                                  ...
                                  <div>
                                              <label className="block text-sm font-medium mb-1">Digital ID (DID)</label>label>
                                              <input 
                                                              value={did} 
                                  ...
                                  <div>
                                              <label className="block text-sm font-medium mb-1">Secret (for ZKP Commitment)</label>label>
                                              <input 
                                                              type="password"
                                                              value={secret} 
